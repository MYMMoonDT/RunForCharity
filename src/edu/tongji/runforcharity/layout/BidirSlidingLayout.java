package edu.tongji.runforcharity.layout;
        ...
        OnTouchListener
{
     ...
     *            纵向移动的距离
     */
    public void checkSlideState(int moveDistanceX, int moveDistanceY)
    {
    ...
    class LeftMenuScrollTask extends AsyncTask<Integer, Integer, Integer>
    {
        ...
        protected Integer doInBackground(Integer... speed)
        {
            ...
            isSliding = false;
            System.out.println("--------------------LeftMenuScrollTask:"
                    + rightMargin);
            return rightMargin;
        }
